...
$body = "Name: $name \n\nEmail: $email \n\nPhone Number: $phone \n\nSubject: $subject \n\nComments:\n $comments";
$headers = 'From: LeadHerForward Contact Form <'.$emailTo.'>' . "\r\n" . 'Reply-To: ' . $email;
...
<title>Contact LeadHerForward</title>
...
<p>Thank you for your message, <strong><?php echo $name;?></strong>! Your email was successfully sent and we&rsquo;ll be in touch with you soon.</p>
</div>
...
<option></option>
<option>Question for LeadHerForward team</option>
<option>Comment for LeadHerForward team</option>
</select>
</div>
</div>
